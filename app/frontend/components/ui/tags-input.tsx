...
import { XCircle as RemoveIcon } from "lucide-react";
    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-1 rounded-md bg-white overflow-hidden border border-input",
            {
              "focus-within:ring-primary": activeIndex === -1,
            },
            className,
          )}
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "py-1 relative px-3 rounded-full border-1 flex items-center gap-1 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed",
              )}
              variant={"secondary"}
            >
          ...
          <Input
            ...
            className={cn(
              "outline-0 border-none h-7 min-w-fit flex-1 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 placeholder:text-muted-foreground px-1 bg-transparent",
