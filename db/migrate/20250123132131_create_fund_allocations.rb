class CreateFundAllocations < ActiveRecord::Migration[8.0]
  def change
    create_table :fund_allocations do |t|
      ...
      t.index [:annual_finance_id, :type], unique: true, name: "index_fund_allocations_on_annual_finance_id_and_type"
    end
  end
end
